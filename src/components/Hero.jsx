    ...
    <div className="home-bg flex justify-center">
      ...
      <div className="w-1/2 flex  flex-col justify-center gap-10 pr-7">
        ...
        <div className="flex gap-5">
          <button class="bg-[#5356ff] shadow-md rounded-full px-4 py-2 text-white font-semibold cursor-pointer">
            Call Us Now
          </button>
          <button class="bg-gray-100 border border-gray-800 rounded-full px-5 font-semibold cursor-pointer">
            Learn More
          </button>
        </div>
      </div>
