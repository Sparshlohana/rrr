  ...
  return (
    <div className="home-bg flex justify-center" >
      ...
      <div className="w-1/2 flex  flex-col justify-center gap-10 pr-7">
        <h2 className="uppercase text-[#5356FF] font-extrabold text-2xl">emergency road service provider</h2>
        <h1 className="text-8xl font-extrabold">
          Need Instant Roadside Help?
        </h1>
        <p className="text-2xl font-medium leading-relaxed">{"Don't worry, we've got you covered! Our reliable roadside assistance service is just a call away, ready to help you get back on the road swiftly and safely."}</p>
